  ...
  monitoring+: {
    grafana: {
      ...
      statefulSet:
        ...
        sts.metadata.withNamespace($.monitoring.namespace.metadata.name) +
      ...
      route:
        route.new('grafana') +
        route.metadata.withNamespace($.monitoring.namespace.metadata.name) +
        ...
        route.spec.withRules([
          rule.withBackendRefs([
            rule.backendRefs.withName($.monitoring.grafana.service.app.metadata.name) +
            rule.backendRefs.withNamespace($.monitoring.grafana.service.app.metadata.namespace) +
