...
} +
{
  ...
  esphome: $.new(registry='ghcr.io', name='esphome/esphome', version='2026.7.2'),
...
} +
{
  ...
  'prometheus-config-reloader': $.new(registry='ghcr.io', name='prometheus-operator/prometheus-config-reloader', version='v0.92.1'),
} +
{
